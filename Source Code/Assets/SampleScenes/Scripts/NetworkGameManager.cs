...
public class NetworkGameManager : NetworkBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < sShips.Count; ++i)
        {
            ...
            // Debug.Log(i + ": "  + sShips[i].timeTap);

            if (sShips[i].initDone == false) allInit = false;

            //Debug.Log("Init done: " + sShips[i].initDone);

        }

        // if (allInit)
        // {
        //     // int unixIn5 = Tempus.UnixTimeNow() + 5;

        //     for (int i = 0; i < sShips.Count; ++i)
        //     {
        //         sShips[i].initDone = false;
        //         // sShips[i].playUnix = unixIn5;
        //         //sShips[i].TakeDamage(1);
        //         Debug.Log("Play: " + i);
        //     }
        //     allInit = false;
        // }
